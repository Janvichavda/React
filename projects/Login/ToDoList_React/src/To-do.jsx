...
// // import { Icon } from 'bootstrap-icons-react';
...
//     const inpChangeEvent = (e) => {
//         addTodo([...todo, e.target.value])
//     }
//     const handleChange = (e, index) => {
//         // let { todo, value } = e.target;
//         // let onChangeValue = [addTodo];
//         // onChangeValue[index][todo] = value;
//         // addTodo(onChangeValue);
//         const newTodo = [...todo];
...
//                             <div class="col">
//                                 {/* {todo.map((todo, index) => (<input key={index}
//                                     value={todo} onChange={(e) => handleChange(e, index)} class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded" type="text" placeholder="Add new .." />))} */}
//                                 <input onClick={(e) => handleChange(e)} class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded" type="text" placeholder="Add new .." />
//                             </div>
...
//                                 <button onClick={inpChangeEvent} type="button" class="btn btn-primary">Add</button>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
...
//                                 <input type="text" class="form-control form-control-lg border-0 edit-todo-input bg-transparent rounded px-3" readonly value={todo} />
